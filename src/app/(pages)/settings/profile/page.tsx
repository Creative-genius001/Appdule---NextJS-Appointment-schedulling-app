  ...
  return (
    ...
    <div className='bg-[#fafafa] text-dark w-[100%] pt-8 lg:px-[70px] sm:px-[20px] min-h-screen'>  
        ...
        <div className='mt-8 link-div pb-4 flex items-center justify-between '>
          <div>
            <h2 className='font-bold text-[20px]  '>Update your profile</h2>
            <p className='font-medium text-[gray]'>Edit your details and save so that your information can stay up to date.</p>
          </div>
          <button className='flex items-center justify-center rounded-[7px] w-auto px-12 py-3 mt-3 bg-lightblue text-[white] font-medium hover:bg-[#1da5a0] transition-all ease-in-out '><HiOutlineSave className='mr-3 text-[1.3rem] ' />Save</button>
        </div>
